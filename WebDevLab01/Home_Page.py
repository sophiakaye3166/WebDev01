...
st.header("CS 1301")
st.subheader("Web Development - Section B")
st.subheader("Sophia Kaye")
...
1. **Portfolio**: A little bit about me and my work.
2. **BuzzFeed Quiz**: Take this fun quiz to test your Harry Potter knowledge!
